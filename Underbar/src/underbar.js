...
// A note regarding the note above: no exercises were completed when I started work. --RB
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if(arg in alreadyCalled){
        ...
        return (alreadyCalled[arg] = func.apply(this, arguments));
      }
    }
  };
  ...
  _.shuffle = function(array) {
    ...
    var result = [];
    //first pick a random element of aCopy
    //result.push(saidRandomElement) also remove from aCopy
    //continue until no elements in aCopy are left.
    for(var i = aCopy.length; i > 0; i--){
      var randIndex = Math.floor(Math.random() * aCopy.length);
      result.push(aCopy[randIndex]);
      aCopy.splice(randIndex, 1);
    }
    return result;
  };
...
// Write yourself a program that will take an array containing strings and break those strings into individual words.

var arr = ['Robert Bowie', 'rob_gdi@yahoo.com'];
var myName = arr[0];
var result = [];
